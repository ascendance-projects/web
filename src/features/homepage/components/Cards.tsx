...
import { AreaChart, CalendarRange, EarthLock, Gauge, Leaf, PaintBucket, } from 'lucide-react'
...
function Card ({icon: Icon, title, description}: CardProps) {
  return (
    <div
      className="group relative flex flex-col gap-4 overflow-clip rounded-3xl p-8 ring ring-zinc-500 transition-all hover:scale-105 hover:ring-emerald-400">
      <div
        className="absolute -inset-[1000%] -z-10 animate-[spin_10s] bg-[conic-gradient(from_90deg_at_50%_50%,#262626_0%,#161616_50%,#121212_100%)] opacity-0 transition-opacity group-hover:opacity-100"/>
